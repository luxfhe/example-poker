...
// Use the constant
const LuxFHE_LOCAL_FAUCET_URL = LUXFHE_LOCAL_FAUCET_URL;
...
export const useLocalLuxFHEFaucet = (_walletClient?: WalletClient): RequestFunc => {
  ...
  const result: RequestFunc = async (to: string) => {
    ...
    const notificationId = notification.loading(<RequestNotification message="Requesting funds from the faucet" />);
